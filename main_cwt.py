...
from sim.utils.record_utils import logconfig, add_log_debug, add_log_info, record_exp_result
...
# nohup python main_cwt.py -m logistic -d mnist -s 1 -R 100 -K 10 -M 500 -P 10 --partition iid --alpha 2 10 --optim sgd --lr 0.1 --lr-decay 0.98 --momentum 0 --batch-size 20 --seed 1234 --eval-case 1 --log Print &
