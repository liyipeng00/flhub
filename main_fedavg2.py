...
def customize_record_name(args):
    ...
    record_name = f'FedAvg_M{args.M}_P{args.P}_K{args.K}_R{args.R}_{args.m}_{args.d}_{args.partition}{args.alpha[0]},{args.alpha[1]}'\
...
def main():
    ...
    for round in range(args.R):
        ...
        param_avg = server.aggregate(local_params)
